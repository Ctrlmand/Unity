...
////// Emissive:
                ...
                float3 emissive = (max((((1.0 - round(length((_Dot_Size_var + ( (frac((float2((sceneUVs.x * 2 - 1)*(_ScreenParams.r/_ScreenParams.g), sceneUVs.y * 2 - 1).rg*_Dot_Tiel_var)) - node_4118) * (node_6899 - _Dot_Size_var) ) / (node_6899 - node_4118)))))*node_1215)*_Dot_Color_var.rgb),0.0)+((_Light_Color_var.rgb*node_1215)+((1.0 - node_1215)*_Dark_Color_var.rgb)));
